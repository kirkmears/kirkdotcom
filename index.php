...
<body>
    ...
    <p style="text-align: center;">
        <img src="icons/1-14-2009-c.jpg" alt="" width="889" height="192">
    </p>
    ...
    <!-- 7-day weather image -->
    <p style="text-align: center;">
        <img src="https://cdn.tegna-media.com/wfaa/weather/7day.jpg" alt="" width="511" height="287">
    </p>

    <!-- Weather page: FIXED iframe (was unclosed + had no dimensions) -->
    <p style="text-align: center;">
        <iframe src="https://kirkdotcom.azurewebsites.net/weather.html?embed=1" width="400" height="1200" style="border: none;"></iframe>
    </p>
    <p style="text-align: center;">
        <a href="https://kirkdotcom.azurewebsites.net/weather.html" target="_blank">Open weather page full-size</a>
    </p>

    <!-- Various links -->
    <!-- NOTE: 192.168.0.296 is not a valid IP address (octet 296 > 255). Fix it to the real IP. -->
    ...
    <p style="text-align: center;">
        <a href="http://192.168.0.239" target="_blank"><img src="icons/index.html" alt="" width="0" height="0"></a>
    </p>

    <!-- Local radar -->
    <p style="text-align: center;">
        <img src="https://radar.weather.gov/ridge/standard/KFWS_loop.gif" alt="" width="600" height="550">
    </p>
    ...
    <table width="750" height="50" cellspacing="10" cellpadding="10" border="5" align="center">
        <tbody>
            <tr>
                <td style="text-align: center;"><a href="https://www.kirkmears.com/lightning" target="_blank"><img src="icons/light.png" alt="" width="120" height="90" border="2"></a></td>
    ...
    <!-- 239 splash image -->
    <p style="text-align: center;">
        <a href="http://192.168.0.239" target="_blank"><img src="icons/splash.jpg" alt="" width="80" height="80"></a>
    </p>
